...
class ForgetPasswordPassword extends ConsumerStatefulWidget {
  const ForgetPasswordPassword({super.key});

  @override
  ConsumerState<ForgetPasswordPassword> createState() => _ForgetPasswordPasswordState();
}

class _ForgetPasswordPasswordState extends ConsumerState<ForgetPasswordPassword> {
